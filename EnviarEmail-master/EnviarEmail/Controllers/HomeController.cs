    ...
    public class HomeController : Controller
    {
        ...
        public bool SendMail(string email)
        {
            ...
            try
            {
                ...
                // Remetente
                _mailMessage.From = new MailAddress("larissaevellem1997@gmail.com");

                // Destinatario seta no metodo abaixo

                //Contrói o MailMessage
                _mailMessage.CC.Add(email);
                _mailMessage.Subject = "Teste Larissa";
                ...
                _smtpClient.Credentials = new NetworkCredential("sakura_evellem@hotmail.com", "goiania1997");
